...
class GPT(nn.Module):
    ...
    def get_config(self):
        """
        Return the model's configuration as a dictionary.
        """
        # Example configuration, adjust according to your model's parameters
        config = {
    ...
    def to_pretrained(self, save_directory):
        ...
        api = HfApi()
        token = HfFolder.get_token()  # ensure you have logged in via huggingface-cli login
